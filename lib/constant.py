...
lexiques = {
    "transport_term": pd.read_csv("resources/lexiques/dico_transport.txt"),
    "change_verb":pd.read_csv("resources/lexiques/dico_verbe_changement.txt"),
    "deplacement_verb":pd.read_csv("resources/lexiques/dico_verbe_déplacement.txt"),
    "attribut":pd.read_csv("resources/lexiques/dico_attribut_transport.txt")
}
